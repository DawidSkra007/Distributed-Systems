...
public void connectionTest() throws Exception {
    ...
    QName serviceName = new QName("http://core.service/", "girlsallowed"); 
    Service service = Service.create(wsdlUrl, serviceName); 
    QName portName = new QName("http://core.service/", "girlsallowedPort"); 
    ...
    Quotation quotation = quotationService
        ...
        assertEquals(quotation.company, "Girls Allowed Inc."); 
        assertEquals(quotation.reference, "GA001000");
    }
