...
public void connectionTest() throws Exception {
    ...
    QName serviceName = new QName("http://core.service/", "auldfellas"); 
    Service service = Service.create(wsdlUrl, serviceName); 
    QName portName = new QName("http://core.service/", "auldfellasPort"); 
    ...
    Quotation quotation = quotationService
        ...
        assertEquals(quotation.reference, "AF001000");
    }
