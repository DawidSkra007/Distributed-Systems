...
public void connectionTest() throws Exception {
    ...
    QName serviceName = new QName("http://core.service/", "dodgygeezers"); 
    Service service = Service.create(wsdlUrl, serviceName); 
    QName portName = new QName("http://core.service/", "dodgygeezersPort"); 
    ...
    Quotation quotation = quotationService
        ...
        assertEquals(quotation.company, "Dodgy Geezers Corp."); 
        assertEquals(quotation.reference, "DG001000");
    }
