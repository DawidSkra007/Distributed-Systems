...
public class Broker extends AbstractActor {
    ...
    public Receive createReceive() {
        ...
        .match(ClientInfoMessage.class, msg -> {
            ...
            System.out.println("Client: " + token + " Started.");
            System.out.println("Info: " + msg.getClientInfo().name);
        ...
        .match(TimeOutMessage.class, msg -> {
            System.out.println("Size of quotation cache: " + cache.get(msg.getToken()).getQuotations().size());
            clientRef.tell(cache.get(msg.getToken()), getSelf());
            cache.remove(msg.getToken()); // send offer to client and remove from cache
            System.out.println("CLient: " + msg.getToken() + " Finishied.");
        })
        .build();
    }
